...
namespace Dapper.Moon
{
    public interface IQueryable<T>
    {
        ...
        Task<int> CountAsync(Expression<Func<T, object>> field);
        TResult Sum<TResult>(Expression<Func<T, TResult>> field);
        Task<TResult> SumAsync<TResult>(Expression<Func<T, TResult>> field);
        TResult Avg<TResult>(Expression<Func<T, TResult>> field);
        Task<TResult> AvgAsync<TResult>(Expression<Func<T, TResult>> field);
    ...
    public interface IQueryable<T, T2> : IQueryable<T>
    {
        ...
        Task<int> CountAsync(Expression<Func<MoonFunc<T, T2>, object>> field);
        TResult Sum<TResult>(Expression<Func<MoonFunc<T, T2>, TResult>> field);
        Task<TResult> SumAsync<TResult>(Expression<Func<MoonFunc<T, T2>, TResult>> field);
        TResult Avg<TResult>(Expression<Func<MoonFunc<T, T2>, TResult>> field);
        Task<TResult> AvgAsync<TResult>(Expression<Func<MoonFunc<T, T2>, TResult>> field);
        TResult Max<TResult>(Expression<Func<MoonFunc<T, T2>, TResult>> field);
        Task<TResult> MaxAsync<TResult>(Expression<Func<MoonFunc<T, T2>, TResult>> field);
        TResult Min<TResult>(Expression<Func<MoonFunc<T, T2>, TResult>> field);
        Task<TResult> MinAsync<TResult>(Expression<Func<MoonFunc<T, T2>, TResult>> field);
    ...
    public interface IQueryable<T, T2, T3> : IQueryable<T>
    {
        ...
        Task<int> CountAsync(Expression<Func<MoonFunc<T, T2, T3>, object>> field);
        Task<TResult> SumAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3>, TResult>> field);
        Task<TResult> AvgAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3>, TResult>> field);
        Task<TResult> MaxAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3>, TResult>> field);
        Task<TResult> MinAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3>, TResult>> field);
    ...
    public interface IQueryable<T, T2, T3, T4> : IQueryable<T>
    {
        ...
        Task<int> CountAsync(Expression<Func<MoonFunc<T, T2, T3, T4>, object>> field);
        Task<TResult> SumAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3, T4>, TResult>> field);
        Task<TResult> AvgAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3, T4>, TResult>> field);
        Task<TResult> MaxAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3, T4>, TResult>> field);
        Task<TResult> MinAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3, T4>, TResult>> field);
    ...
    public interface IQueryable<T, T2, T3, T4, T5> : IQueryable<T>
    {
        ...
        Task<int> CountAsync(Expression<Func<MoonFunc<T, T2, T3, T4, T5>, object>> field);
        Task<TResult> SumAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3, T4, T5>, TResult>> field);
        Task<TResult> AvgAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3, T4, T5>, TResult>> field);
        Task<TResult> MaxAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3, T4, T5>, TResult>> field);
        Task<TResult> MinAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3, T4, T5>, TResult>> field);
    ...
    public interface IQueryable<T, T2, T3, T4, T5, T6> : IQueryable<T>
    {
        ...
        Task<int> CountAsync(Expression<Func<MoonFunc<T, T2, T3, T4, T5, T6>, object>> field);
        Task<TResult> SumAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3, T4, T5, T6>, TResult>> field);
        Task<TResult> AvgAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3, T4, T5, T6>, TResult>> field);
        Task<TResult> MaxAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3, T4, T5, T6>, TResult>> field);
        Task<TResult> MinAsync<TResult>(Expression<Func<MoonFunc<T, T2, T3, T4, T5, T6>, TResult>> field);
